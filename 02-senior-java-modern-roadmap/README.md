...
|---|---|
| Pattern bằng Java thuần | [`../01-code-projects/01-java-patterns`](../01-code-projects/01-java-patterns/README.md) |
| Spring DI, registry, proxy/AOP | [`../01-code-projects/02-spring-core-patterns`](../01-code-projects/02-spring-core-patterns/README.md) |
| Hexagonal + Spring Modulith | [`../01-code-projects/03-hexagonal-modulith`](../01-code-projects/03-hexagonal-modulith/README.md) |
| Reliable event + idempotent listener | [`../01-code-projects/04-reliable-events`](../01-code-projects/04-reliable-events/README.md) |
| HTTP client + resilience | [`../01-code-projects/05-http-resilience`](../01-code-projects/05-http-resilience/README.md) |
| Observation + concurrency | [`../01-code-projects/06-observability-concurrency`](../01-code-projects/06-observability-concurrency/README.md) |
| Virtual Threads + H2/Hikari/backpressure | [`../01-code-projects/07-virtual-threads-system-design`](../01-code-projects/07-virtual-threads-system-design/README.md) |

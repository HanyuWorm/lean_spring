...
Lab đã có: `01-code-projects/07-virtual-threads-system-design` dùng H2/Hikari để thấy cơ chế. Bước production-like tiếp theo là chạy cùng test với PostgreSQL/Testcontainers vì H2 không đại diện hoàn toàn cho locking, planner và kiểu dữ liệu của PostgreSQL.

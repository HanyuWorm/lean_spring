...
Demo: [`../03-spring-native-patterns-deep-dive/02-proxy-aop`](../03-spring-native-patterns-deep-dive/02-proxy-aop/README.md) và [`05-template-callback`](../03-spring-native-patterns-deep-dive/05-template-callback/README.md).

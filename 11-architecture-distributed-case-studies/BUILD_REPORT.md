...
```powershell
cd I:\Dev\DS\11-architecture-distributed-case-studies\repositories\debezium-examples\outbox
...
```powershell
cd I:\Dev\DS\11-architecture-distributed-case-studies\repositories\sample-spring-microservices-advanced
...
```powershell
cd I:\Dev\DS\11-architecture-distributed-case-studies\repositories\miaosha\miaosha-v1
...
```powershell
cd I:\Dev\DS\11-architecture-distributed-case-studies\repositories\loom-webflux-benchmarks
$env:JAVA_HOME = 'C:\Program Files\Java\jdk-21'
$env:Path = "$env:JAVA_HOME\bin;$env:Path"
...
```powershell
cd I:\Dev\DS\11-architecture-distributed-case-studies\repositories\spring-petclinic-microservices
$env:JAVA_HOME = 'C:\Program Files\Java\jdk-21'
$env:Path = "$env:JAVA_HOME\bin;$env:Path"

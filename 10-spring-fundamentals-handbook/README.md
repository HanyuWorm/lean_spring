...
- [`../09-spring-native-patterns-deep-dive`](../09-spring-native-patterns-deep-dive/README.md): DI, proxy, strategy, factory, callback, chain, event, adapter/decorator.
- [`../07-virtual-threads-system-design`](../07-virtual-threads-system-design/README.md): H2, Hikari và Virtual Threads.
- [`../04-reliable-events`](../04-reliable-events/README.md): transaction-bound event và idempotency.
